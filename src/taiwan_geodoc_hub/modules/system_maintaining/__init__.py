...
from taiwan_geodoc_hub.adapters.firestore.process_state_adapter import (
    ProcessStateAdapter,
)
...
from taiwan_geodoc_hub.utils.firebase.credentials_from_env import credentials_from_env
...
class SystemMaintainingModule(Module):
    def configure(self, binder):
        ...
        binder.bind(ProcessStateRepository, to=ClassProvider(ProcessStateAdapter))
...
system_maintaining_module = SystemMaintainingModule()
