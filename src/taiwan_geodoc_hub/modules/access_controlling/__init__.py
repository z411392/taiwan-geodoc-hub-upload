...
from taiwan_geodoc_hub.modules.access_controlling.domain.ports.get_user_from_id_token_port import (
    GetUserFromIdTokenPort,
)
from taiwan_geodoc_hub.adapters.auth.user_auth_adapter import UserAuthAdapter
from taiwan_geodoc_hub.modules.access_controlling.domain.ports.get_tenant_by_id_port import (
    GetTenantByIdPort,
)
from taiwan_geodoc_hub.adapters.firestore.tenant_firestore_adapter import (
    TenantFirestoreAdapter,
)
from taiwan_geodoc_hub.modules.access_controlling.domain.ports.get_role_by_id_port import (
    GetRoleByIdPort,
)
from taiwan_geodoc_hub.adapters.firestore.role_firestore_adapter import (
    RoleFirestoreAdapter,
)
from taiwan_geodoc_hub.modules.access_controlling.domain.ports.credential_repository import (
    CredentialRepository,
)
from taiwan_geodoc_hub.adapters.file_system.credential_file_system_adapter import (
    CredentialFileSystemAdapter,
)
from taiwan_geodoc_hub.modules.access_controlling.domain.ports.auth_service import (
    AuthService,
)
from taiwan_geodoc_hub.adapters.browser.auth_pyppeteer_adapter import (
    AuthPyppeteerAdapter,
)
from taiwan_geodoc_hub.modules.access_controlling.domain.ports.tenant_snapshot_ownership_repository import (
